...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['survey-administrator', 'team-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Gift Card', path: '/gift-cards', entity: 'gift_card', service: AccessServiceEnum.PROJECT, icon: FiGift },
    { name: 'Survey', path: '/surveys', entity: 'survey', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
    {
      name: 'User Reward',
      path: '/user-rewards',
      entity: 'user_reward',
